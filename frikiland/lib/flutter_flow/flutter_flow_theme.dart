...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color amarillo = Color(0xFFEFDC39);
  late Color terracota = Color(0xFFCC3F0D);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color amarillo = Color(0xFFEFDC34);
  late Color terracota = Color(0xFF6EF6B0);
}

  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CarritoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarritoRecord> cartCarritoRecordList = snapshot.data!;
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        await listViewCarritoRecord
                                                                          ...
                                                                          ...createCarritoRecordData(
                                                                            subtotal:
                                                                                functions.restarSubtotal(listViewCarritoRecord.subtotal, containerProductosRecord.precio),
                                                                          ),
                                                                          ...mapToFirestore(
                                                                            {
                                                                    ...
                                                                    FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        await listViewCarritoRecord
                                                                          ...
                                                                          ...createCarritoRecordData(
                                                                            subtotal:
                                                                                functions.sumarSubtotal(listViewCarritoRecord.subtotal, containerProductosRecord.precio),
                                                                          ),
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'cantidad': FieldValue.increment(1),
